...
class PostDetail extends React.Component {
  componentDidMount() {
    // @ts-expect-error TS(2339) FIXME: Property 'fetchPost' does not exist on type 'Reado... Remove this comment to see the full error message
    ...
    return (
      <>
        ...
        <PostDetailInfoBarContainer
          // @ts-expect-error TS(2322) FIXME: Type '{ id: any; views: any; upvotePercentage: any... Remove this comment to see the full error message
          id={post.id}
          views={post.views}
